...
/**
 * VisitaId generated by hbm2java
 */
@Embeddable
public class VisitaId implements java.io.Serializable {
	...
	public VisitaId(String idProfesional, int idLocalidad, Date fecha) {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof VisitaId))
			return false;
		VisitaId castOther = (VisitaId) other;
