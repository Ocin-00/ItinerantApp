...
@WebServlet("/supervisor/estadisticas_mancomunales")
public class EstadisticasMancomunalesServlet extends BaseServlet {
	private static final long serialVersionUID = 1L;
       
    public EstadisticasMancomunalesServlet() {
        super();
    }
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {		
		...
		supervisorServicios.estadisticasMancomunales();				
	}
