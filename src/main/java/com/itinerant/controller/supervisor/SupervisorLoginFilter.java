...
public class SupervisorLoginFilter extends HttpFilter implements Filter {

    public SupervisorLoginFilter() {
        super();
    }
	...
	public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain) throws IOException, ServletException {
		...
		if(loggedIn) {
			...
			boolean esSupervisor = usuarioInternoServicios.getRol(login).equals(Rol.SUPERVISOR.toString());
			if(esSupervisor) {
