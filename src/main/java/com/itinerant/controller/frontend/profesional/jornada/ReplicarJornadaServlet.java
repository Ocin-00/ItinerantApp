...
@WebServlet("/profesional/replicar_jornada")
public class ReplicarJornadaServlet extends BaseServlet {
	private static final long serialVersionUID = 1L;

	public ReplicarJornadaServlet() {
		super();
	}
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		jornadaServicios.replicarJornada();
	}
